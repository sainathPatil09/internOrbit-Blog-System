...
const About = () => {
  return (
    <>
      <div className="about-container w-3/4 mx-auto space-y-5 text-xl p-5">
        ...
        <p className="about-description">
          ...
          space where thoughts, ideas, and stories come to life. Our platform is
          designed to connect writers, readers, and communities through the
          power of words.
        </p>

        <section className="about-section">
          <h2 className="bg-blue-300 text-slate-700 font-semibold w-fit px-2 py-1 rounded-lg">
            Who We Are
          </h2>
          <p>
            ...
            just starting out, our platform provides a simple and elegant way to
            share your thoughts and engage with like-minded readers.
          </p>
        </section>
        ...
        <section className="about-section">
          ...
          <ul>
            <li>
              <strong>Write & Publish:</strong> Create stunning blog posts with
        ...
        <div className="about-cta">
          ...
          <p>
            ...
            <span className="brand-name">BlogApp</span> welcomes you to a world
